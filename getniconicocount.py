    ...
    if str(elem.tag) == "view_counter":
      if int(elem.text) > max:
        if int(elem.text) > 9900000 and int(elem.text) < 10000000:
          print("UP" + str(max - int(elem.text)) + ": " + str(elem.text) + ", 神話入りまで残り" + str(10000000 - int(elem.text)) + "回")
        if int(elem.text) > 10000000 and int(elem.text) < 10000100:
          print("UP" + str(max - int(elem.text)) + ": " + str(elem.text) + ", 神話入り達成！！！！")
        if int(elem.text) > 990000 and int(elem.text) < 1000000:
          print("UP" + str(max - int(elem.text)) + ": " + str(elem.text) + ", 伝説入りまで残り" + str(1000000 - int(elem.text)) + "回")
        if int(elem.text) > 1000000 and int(elem.text) < 1000050:
          print("UP" + str(max - int(elem.text)) + ": " + str(elem.text) + ", 伝説入り達成！！！！")
        if int(elem.text) > 95000 and int(elem.text) < 100000:
          print("UP" + str(max - int(elem.text)) + ": " + str(elem.text) + ", 殿堂入りまで残り" + str(100000 - int(elem.text)) + "回")
        if int(elem.text) > 100000 and int(elem.text) < 100025:
          print("UP" + str(max - int(elem.text)) + ": " + str(elem.text) + ", 殿堂入り達成！！！！")
        max = int(elem.text)
